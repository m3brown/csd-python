...
def test_buy_product_with_payment_expects_product(is_payment_made_mock, vending_machine):
    # Arrange
...
@patch("payments.PaymentProcessor.is_payment_made")
def test_buy_product_with_no_payment_expects_exception(is_payment_made_mock, vending_machine):
    # Arrange
...
@patch("payments.PaymentProcessor.is_payment_made")
def test_get_message_returns_insert_money_message_when_purchase_fails(is_payment_made_mock, vending_machine):
    # Arrange
    is_payment_made_mock.return_value = False
